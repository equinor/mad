...
export class TechnicalClarificationsService {
     ...
     * @throws ApiError
     */
    static lookupTechnicalClarification({ recordId, includeStatusDetails = false, includeTasks = false, includeAttachments = false, includeTagDetails = false, includePersonResponsible = false, includeCreatedByDetails = false, }) {
     ...
     * @throws ApiError
     */
    static searchTechnicalClarifications({ filter, includePersonResponsible = false, statusId, plantId, locationId, systemId, planningPlantId, plannerGroupId, maxDaysSinceActivation, hasPersonResponsible = false, createdAfterDatetime, includeCompleted = false, personResponsibleEmail, }) {
        return __request(OpenAPI, {
            method: 'GET',
