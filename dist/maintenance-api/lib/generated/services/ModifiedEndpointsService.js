...
export class ModifiedEndpointsService {
     ...
     * @throws ApiError
     */
    static lookupMaintenancePlan({ planId, includeItems = true, includeItemCalls = true, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static lookupMaintenancePlanItem({ planId, itemId, includeItemCalls = true, includeItemObjectList = false, includeObjectListLinkage = true, includeItemTaskList = false, }) {
        return __request(OpenAPI, {
            method: 'GET',
