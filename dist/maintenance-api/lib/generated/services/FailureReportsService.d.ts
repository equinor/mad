...
export declare class FailureReportsService {
    /**
     ...
     * @throws ApiError
     */
    static lookupFailureReport({ recordId, includeStatusDetails, includeTagDetails, includeActivities, includeTasks, includeAttachments, includeAdditionalMetadata, includeCreatedByDetails, includeUrlReferences, }: {
        /**
