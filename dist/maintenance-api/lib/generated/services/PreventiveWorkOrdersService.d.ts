...
export declare class PreventiveWorkOrdersService {
    /**
     ...
     * @throws ApiError
     */
    static lookupPreventiveWorkOrder({ workOrderId, includeOperations, includeTechnicalFeedback, includeMaterials, includeMaintenanceRecords, includeMaintenancePlanDetails, includeAttachments, includeStatusDetails, includeTagDetails, includeRelatedTags, }: {
        workOrderId: string;
        /**
