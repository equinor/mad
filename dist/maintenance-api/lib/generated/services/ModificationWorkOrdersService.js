...
export class ModificationWorkOrdersService {
     ...
     * @throws ApiError
     */
    static lookupModificationWorkOrder({ workOrderId, includeOperations = true, includeMaterials = true, includeMaintenanceRecords = false, includeAttachments = false, includeStatusDetails = false, includeTagDetails = false, includeRelatedTags = false, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static updateModificationWorkOrderStatus({ workOrderId, statusId, requestBody, completeOutstandingMaintenanceRecords = true, }) {
        return __request(OpenAPI, {
            method: 'PATCH',
