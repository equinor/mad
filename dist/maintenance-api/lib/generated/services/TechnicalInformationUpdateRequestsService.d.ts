...
export declare class TechnicalInformationUpdateRequestsService {
    /**
     ...
     * @throws ApiError
     */
    static lookupTechnicalInformationUpdateRequest({ recordId, includeStatusDetails, includeTasks, includeAttachments, includeTagDetails, includePersonResponsible, includeCreatedByDetails, }: {
        /**
     ...
     * @throws ApiError
     */
    static updateTechnicalInformationUpdateRequest({ recordId, requestBody, }: {
        /**
         * The recordId of the technical information update request
         */
        recordId: string;
     ...
     * @throws ApiError
     */
    static downloadTechnicalInformationUpdateRequestAttachment({ recordId, attachmentId, }: {
        recordId: string;
        attachmentId: string;
     ...
     * @throws ApiError
     */
    static uploadTechnicalInformationUpdateRequestAttachment({ recordId, formData, }: {
        recordId: string;
        formData?: {
            files?: Array<Blob>;
        };
     ...
     * @throws ApiError
     */
    static searchTechnicalInformationUpdateRequests({ filter, includePersonResponsible, statusId, plantId, locationId, systemId, tagId, planningPlantId, plannerGroupId, maxDaysSinceActivation, hasPersonResponsible, createdAfterDatetime, includeCompleted, personResponsibleEmail, }: {
        /**
     ...
     * @throws ApiError
     */
    static createTechnicalInformationUpdateRequest({ requestBody, }: {
        /**
     ...
     * @throws ApiError
     */
    static addTechnicalInformationUpdateRequestTasks({ recordId, requestBody, }: {
        /**
     ...
     * @throws ApiError
     */
    static updateTechnicalInformationUpdateRequestTask({ recordId, taskId, requestBody, }: {
        /**
         * id of the technical information update request
         */
        recordId: string;
     ...
     * @throws ApiError
     */
    static updateTechnicalInformationUpdateRequestTaskStatuses({ recordId, taskId, statusId, requestBody, }: {
        /**
         * id of the technical information update request
         */
        recordId: string;
