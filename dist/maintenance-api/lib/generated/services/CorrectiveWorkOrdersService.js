...
export class CorrectiveWorkOrdersService {
     ...
     * @throws ApiError
     */
    static lookupCorrectiveWorkOrder({ workOrderId, includeOperations = true, includeTechnicalFeedback = false, includeMaterials = true, includeMaintenanceRecords = false, includeAttachments = false, includeStatusDetails = false, includeTagDetails = false, includeRelatedTags = false, }) {
     ...
     * @throws ApiError
     */
    static updateCorrectiveWorkOrder({ workOrderId, requestBody, }) {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/work-orders/corrective-work-orders/{work-order-id}',
            path: {
     ...
     * @throws ApiError
     */
    static addCorrectiveWorkOrderOperations({ workOrderId, requestBody, }) {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    static updateCorrectiveWorkOrderOperation({ workOrderId, operation, requestBody, }) {
        return __request(OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    static addCorrectiveWoOperationsTimeTicket({ workOrderId, operation, requestBody, }) {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    static downloadCorrectiveWorkOrderAttachment({ workOrderId, attachmentId, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static updateCorrectiveWorkOrderStatus({ workOrderId, statusId, requestBody, completeOutstandingMaintenanceRecords = true, }) {
        return __request(OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    static searchCorrectiveWorkOrder({ filter, statusId, plantId, maxDaysSinceActivation, maxWorkOrders, areaId, locationId, requiredEndDate, systemId, maintenanceTypeId, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static createCorrectiveWorkOrder({ requestBody, }) {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/work-orders/corrective-work-orders',
            body: requestBody,
