...
export declare class CertificationReportsService {
    /**
     ...
     * @throws ApiError
     */
    static lookupCertification({ recordId, includeStatusDetails, includeTagDetails, includeAttachments, includeMeasuringPoints, includeLastMeasurement, includeCreatedByDetails, }: {
        /**
     ...
     * @throws ApiError
     */
    static searchCertificationReports({ filter, statusId, plantId, maxDaysSinceActivation, createdAfterDatetime, includeCompleted, }: {
        /**
