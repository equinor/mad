...
export class PreventiveWorkOrdersService {
     ...
     * @throws ApiError
     */
    static lookupPreventiveWorkOrder({ workOrderId, includeOperations = true, includeTechnicalFeedback = false, includeMaterials = false, includeMaintenanceRecords = false, includeMaintenancePlanDetails = false, includeAttachments = false, includeStatusDetails = false, includeTagDetails = false, includeRelatedTags = false, }) {
     ...
     * @throws ApiError
     */
    static updatePreventiveWorkOrder({ workOrderId, requestBody, }) {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/work-orders/preventive-work-orders/{work-order-id}',
            path: {
     ...
     * @throws ApiError
     */
    static addPreventiveWorkOrderOperations({ workOrderId, requestBody, }) {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    static updatePreventiveWorkOrderOperation({ workOrderId, operation, requestBody, }) {
        return __request(OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    static addPreventiveWoOperationsTimeTicket({ workOrderId, operation, requestBody, }) {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    static downloadPreventiveWorkOrderAttachment({ recordId, attachmentId, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static updatePreventiveWorkOrderStatus({ workOrderId, statusId, requestBody, }) {
        return __request(OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    static searchPreventiveWorkOrders({ filter, statusId, plantId, maxDaysSinceActivation, workOrderId, earliestDate, maxWorkOrders, locationId, areaId, plannedDate, systemId, maintenanceTypeId, }) {
        return __request(OpenAPI, {
            method: 'GET',
