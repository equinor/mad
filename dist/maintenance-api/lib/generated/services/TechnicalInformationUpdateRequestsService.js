...
export class TechnicalInformationUpdateRequestsService {
     ...
     * @throws ApiError
     */
    static lookupTechnicalInformationUpdateRequest({ recordId, includeStatusDetails = false, includeTasks = false, includeAttachments = false, includeTagDetails = false, includePersonResponsible = false, includeCreatedByDetails = false, }) {
     ...
     * @throws ApiError
     */
    static searchTechnicalInformationUpdateRequests({ filter, includePersonResponsible = false, statusId, plantId, locationId, systemId, tagId, planningPlantId, plannerGroupId, maxDaysSinceActivation, hasPersonResponsible = false, createdAfterDatetime, includeCompleted = false, personResponsibleEmail, }) {
        return __request(OpenAPI, {
            method: 'GET',
