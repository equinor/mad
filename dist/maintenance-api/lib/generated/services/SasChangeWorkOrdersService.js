...
export class SasChangeWorkOrdersService {
     ...
     * @throws ApiError
     */
    static lookupSasChangeWorkOrder({ workOrderId, includeOperations = true, includeMaterials = true, includeMaintenanceRecords = false, includeAttachments = false, includeStatusDetails = false, includeTagDetails = false, includeRelatedTags = false, }) {
        return __request(OpenAPI, {
            method: 'GET',
