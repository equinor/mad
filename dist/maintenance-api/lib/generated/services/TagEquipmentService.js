...
export class TagEquipmentService {
     ...
     * @throws ApiError
     */
    static lookupTag({ plantId, tagId, includeMaintenanceRecords = true, includeMaintenanceRecordTypes, includeWorkOrders = true, includeWorkOrderTypes, includeInstalledEquipment = false, includeCatalogProfileDetails = false, includeMaintenancePlanItems = false, includeMeasuringPoints = false, includeLastMeasurement = false, includeCharacteristics = false, includeBillOfMaterials = false, }) {
     ...
     * @throws ApiError
     */
    static getTagHierachy({ plantId, filter, rootTags, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static getTagHierarchy({ plantId, filter, rootTagIdAnyOf, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static getEquipmentList({ plantId, filter, equipmentCategoryIdAnyOf, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static lookupEquipment({ equipmentId, includeMaintenanceRecords = true, includeMaintenanceRecordTypes, includeOnlyOpenMaintenanceRecords = false, includeWorkOrders = true, includeWorkOrderTypes, includeOnlyOpenWorkOrders = false, includeCatalogProfileDetails = false, includeCharacteristics = false, includeAttachments = false, includeMeasuringPoints = false, includeLastMeasurement = false, includeStatusDetails = false, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static updateEquipment({ equipmentId, requestBody, }) {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/equipment/{equipment-id}',
            path: {
     ...
     * @throws ApiError
     */
    static addCharacteristicsToEquipment({ equipmentId, requestBody, }) {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    static createEquipment({ requestBody, }) {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/equipment',
            body: requestBody,
     ...
     * @throws ApiError
     */
    static searchEquipment({ equipmentIdAnyOf, serialNumberAnyOf, vendorPartNumberAnyOf, materialIdAnyOf, includeMaintenanceRecords = true, includeMaintenanceRecordTypes, includeOnlyOpenMaintenanceRecords = false, includeWorkOrders = true, includeWorkOrderTypes, includeOnlyOpenWorkOrders = false, includeCharacteristics = false, perPage = 20, page = 1, }) {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/equipment',
            query: {
     ...
     * @throws ApiError
     */
    static searchEquipmentChangeLog({ filter, subseaWorkOrderId, equipmentIds, changedSinceDate, }) {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    static searchTags({ plantId, filter = 'by-tag-prefix', tagPrefix, tagIdsAnyOf, includeMaintenanceRecords = false, includeMaintenanceRecordTypes, includeWorkOrders = false, includeWorkOrderTypes, includeInstalledEquipment = false, includeCatalogProfileDetails = false, includeMaintenancePlanItems = false, includeMeasuringPoints = false, includeLastMeasurement = false, includeCharacteristics = false, includeBillOfMaterials = false, perPage = 100, page = 1, }) {
        return __request(OpenAPI, {
            method: 'GET',
