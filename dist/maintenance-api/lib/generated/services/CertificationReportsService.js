...
export class CertificationReportsService {
     ...
     * @throws ApiError
     */
    static lookupCertification({ recordId, includeStatusDetails = false, includeTagDetails = false, includeAttachments = false, includeMeasuringPoints = false, includeLastMeasurement = false, includeCreatedByDetails = false, }) {
     ...
     * @throws ApiError
     */
    static searchCertificationReports({ filter, statusId, plantId, maxDaysSinceActivation, createdAfterDatetime, includeCompleted = false, }) {
        return __request(OpenAPI, {
            method: 'GET',
