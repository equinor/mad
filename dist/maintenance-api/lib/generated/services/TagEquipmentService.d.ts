...
export declare class TagEquipmentService {
    /**
     * Tag - Lookup
     * ### Overview
     ...
     * @throws ApiError
     */
    static lookupTag({ plantId, tagId, includeMaintenanceRecords, includeMaintenanceRecordTypes, includeWorkOrders, includeWorkOrderTypes, includeInstalledEquipment, includeCatalogProfileDetails, includeMaintenancePlanItems, includeMeasuringPoints, includeLastMeasurement, includeCharacteristics, includeBillOfMaterials, }: {
        plantId: string;
        tagId: string;
        /**
     ...
     * @throws ApiError
     */
    static lookupEquipment({ equipmentId, includeMaintenanceRecords, includeMaintenanceRecordTypes, includeOnlyOpenMaintenanceRecords, includeWorkOrders, includeWorkOrderTypes, includeOnlyOpenWorkOrders, includeCatalogProfileDetails, includeCharacteristics, includeAttachments, includeMeasuringPoints, includeLastMeasurement, includeStatusDetails, }: {
        /**
     ...
     * @throws ApiError
     */
    static searchEquipment({ equipmentIdAnyOf, serialNumberAnyOf, vendorPartNumberAnyOf, materialIdAnyOf, includeMaintenanceRecords, includeMaintenanceRecordTypes, includeOnlyOpenMaintenanceRecords, includeWorkOrders, includeWorkOrderTypes, includeOnlyOpenWorkOrders, includeCharacteristics, perPage, page, }: {
        /**
     ...
     * @throws ApiError
     */
    static searchTags({ plantId, filter, tagPrefix, tagIdsAnyOf, includeMaintenanceRecords, includeMaintenanceRecordTypes, includeWorkOrders, includeWorkOrderTypes, includeInstalledEquipment, includeCatalogProfileDetails, includeMaintenancePlanItems, includeMeasuringPoints, includeLastMeasurement, includeCharacteristics, includeBillOfMaterials, perPage, page, }: {
        plantId: string;
