...
export declare class CorrectiveWorkOrdersService {
    /**
     ...
     * @throws ApiError
     */
    static lookupCorrectiveWorkOrder({ workOrderId, includeOperations, includeTechnicalFeedback, includeMaterials, includeMaintenanceRecords, includeAttachments, includeStatusDetails, includeTagDetails, includeRelatedTags, }: {
        workOrderId: string;
        /**
     ...
     * @throws ApiError
     */
    static updateCorrectiveWorkOrderStatus({ workOrderId, statusId, requestBody, completeOutstandingMaintenanceRecords, }: {
        workOrderId: string;
        statusId: string;
        /**
