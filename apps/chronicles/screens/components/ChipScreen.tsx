    ...
    return (
        ...
        >
            <View style={styles.textContainer}>
                <Typography>Chips, also known as tags or badges, are advanced badges that represent discrete information.</Typography>
            </View>
            ...
            <View style={styles.chipRow}>
                ...
                <Chip title="Tapable + deletable" onDelete={() => null} onPress={() => null} variant="active" />
                <Chip title="Tapable + deletable" onDelete={() => null} onPress={() => null} variant="error" />
                <Chip title="Tapable + deletable" onDelete={() => null} onPress={() => null} disabled/>
            </View>
            <Spacer />
            <View style={styles.textContainer}>
            ...
            <View style={styles.chipRow}>
                <Chip title="With icon" onDelete={() => null} onPress={() => null} iconName="hoop-house" />
                <Chip title="With icon" onDelete={() => null} onPress={() => null} iconName="home" variant="active"/>
                <Chip title="With icon" onDelete={() => null} onPress={() => null} iconName="sun-snowflake" variant="error" />
                <Chip title="With icon" onDelete={() => null} onPress={() => null} iconName="cash" disabled/>
            </View>
        </ScrollView>
    );
};
