...
import { Button, Cell, EDSStyleSheet, Popover, Spacer, Typography, useStyles } from "@equinor/mad-components";
...
export const PopoverScreen = () => {
    ...
    return (
        <>
            ...
            <Cell.Group title="debug cell group">
                {false && <Cell style={{ height: 60 }} />}
