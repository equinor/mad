...
import { ScaledSize, StyleProp, StyleSheet, ViewProps, ViewStyle, useWindowDimensions } from "react-native";
...
const themeStyles = EDSStyleSheet.create((theme, props: { style: StyleProp<ViewStyle>, dimensions: ScaledSize }) => ({
