...
export class MeasuringPointsService {
     ...
     *
     * @param pointId
     * @param includeLastMeasurement Include the last measurement of the measuring point
     * @param includeMeasurements Include measurements of the measuring point
     * @param includeQualitativeCodeGroup Include possible codes for qualitative measurements if qualitativeCodeGroupId is set
     * @param includeCharacteristics Include characteristics with defined value for the measuring point. Use `include-characteristics-without-value` to retrieve all characteristics available for the measuring point.
     * @param includeCharacteristicsWithoutValue Include all characteristics available for the measuring point regardless if they have a defined value or not. Use `include-characteristics` to only include characteristics with defined value for the measuring point.
    ...
    public static lookupMeasuringPoint(
        ...
        includeQualitativeCodeGroup: boolean = false,
        includeCharacteristics: boolean = false,
        includeCharacteristicsWithoutValue: boolean = false,
     ...
     * Added `include-characteristics` and `include-characteristics-without-value` query parameter.
     *
     * @param filter Filter to limit the measuring points by
     * @param plantId Plant the tag-prefix belongs to
     * @param tagPrefix The first few characters of the tag
     * @param measuringPosition Limit result based on a specific measuring position value
     * @param quantitativeCharacteristic Limit result based on a specific quantitative characteristic value
     * @param qualitativeCodeGroup Limit result based on a specific qualitative code group value
     * @param measuringPointName Limit result based on a specific measuring point name value
     * @param includeLastMeasurement Include the last measurement of the measuring points
     * @param includeMeasurements Include measurements of the measuring points
     * @param includeQualitativeCodeGroup Include possible codes for qualitative measurements if qualitativeCodeGroupId is set
     * @param includeCharacteristics Include characteristics with defined value for the measuring points. Use `include-characteristics-without-value` to retrieve all characteristics available for the measuring points.
     * @param includeCharacteristicsWithoutValue Include all characteristics available for the measuring points regardless if they have a defined value or not. Use `include-characteristics` to only include characteristics with defined value for the measuring points.
     * @returns MeasuringPoint Success
     * @returns ProblemDetails Response for other HTTP status codes
     * @throws ApiError
     */
     ...
     *
     * @param requestBody Measuring point to create
     * @returns ProblemDetails Response for other HTTP status codes
     ...
     *
     * @param pointId
     * @param requestBody Measurement of measuring point to create
     * @returns ProblemDetails Response for other HTTP status codes
     ...
     *
     * @param pointId Measuring point id
     * @param requestBody Characteristics to add to measuring point.
     * @returns ProblemDetails Response for other HTTP status codes
