...
export class MasterDataForMaintenanceRecordsService {
     ...
     *
     * @param maintenanceRecordId The maintenance record to get activity codes for
     * @param catalogProfileId The catalog profile of the functional location/equipment
     * @param maintenanceRecordType The type of maintenance record to get activities or
     ...
     *
     * @param maintenanceRecordId The maintenance record to get task codes for
     * @param catalogProfileId The catalog profile of the functional location/equipment
     * @param maintenanceRecordType The type of maintenance record to get activities or
