...
export class WorkOrderRelationshipsService {
     ...
     *
     * @param workOrderId Id of the work order (can be any type)
     * @param requestBody Define maintenance record to add relationship to
     ...
     *
     * @param workOrderId Id of the work order (can be any type)
     * @param recordId Id of the maintenance record (can be any type)
     * @returns ProblemDetails Response for other HTTP status codes
     * @throws ApiError
     */
