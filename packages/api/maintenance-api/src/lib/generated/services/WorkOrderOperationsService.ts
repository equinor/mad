...
export class WorkOrderOperationsService {
     ...
     *
     * @param operationId
     * @param requestBody Update of Work order details
     ...
     *
     * @param operationId
     * @param requestBody Add material details
     * @returns ProblemDetails Response for other HTTP status codes
     * @returns any Created
     * @throws ApiError
     */
     ...
     *
     * @param operationId
     * @param reservationId Reservation id for the material found through work order lookup with include-materials
     * @returns ProblemDetails Response for other HTTP status codes
     * @throws ApiError
     */
