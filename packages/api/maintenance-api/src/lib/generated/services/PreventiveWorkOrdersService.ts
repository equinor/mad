...
export class PreventiveWorkOrdersService {
     ...
     * @param includeMaintenanceRecords Include related maintenance records (from object list and technical feedback)
     * @param includeMaintenancePlanDetails Include details for maintenance plan
    ...
    public static lookupPreventiveWorkOrder(
        ...
        includeMaterials: boolean = false,
        includeMaintenanceRecords: boolean = false,
        includeMaintenancePlanDetails: boolean = false,
     ...
     * @param workOrderId Preventive Work order id
     * @param earliestDate Earliest date to find maintenance plan history for (optional for filter)
     ...
     * @param areaId Deprecated. Use locationId instead
     * @param plannedDate Earliest date to find maintenance plan history for (optional for filter)
     * @param systemId system-id of the preventive work order
