...
export class MaintenanceRecordsService {
     ...
     * @param externalPartnerRecordId If failure report was initially created in an external system, this represent the unique id of it
     * @param createdAfterDatetime Optional parameter to limit the response to only maintenance records changed after changed-since-datetime but before this datetime
     * @param plantId Plant
     ...
     * @param includeMaintenanceRecordTypes Include maintenance records. If include-maintenance-record-types is not supplied, all support types are returned
