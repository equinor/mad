...
export class MaintenancePlansService {
     ...
     *
     * @param planId
     * @param includeItems Include items of the maintenance plan
     * @param includeItemCalls Include calls for items of the maintenance plan
     ...
     * @param planId The id of the maintenance plan
     * @param itemId The id of the maintenance plan item
     * @param requestBody Update maintenance plan item body
     * @returns ProblemDetails Response for other HTTP status codes
     * @throws ApiError
     */
     ...
     * @param requestBody Update maintenance item status
     * @returns ProblemDetails Response for other HTTP status codes
     * @throws ApiError
     */
     ...
     * @param planId The id of the maintenance plan
     * @param itemId The id of the maintenance plan item
     * @param taskId The id of the task within the maintenance plant item
     * @param requestBody Update task list of maintenance plan item body
     * @returns ProblemDetails Response for other HTTP status codes
     * @throws ApiError
     */
     ...
     * @param itemId The id of the maintenance plan item
     * @param taskId The id of the task within the maintenance plant item
     * @param operationId The id of the operation within the task
     * @param objectListLinkageId The id of the object linkage item
     * @returns ProblemDetails Response for other HTTP status codes
     * @throws ApiError
     */
     ...
     * Added isActive property.
     *
     * @param filter Filter to limit maintenance plans by
     * @param taskId The id of the task within the maintenance plant item
     ...
     * @param itemId The id of the maintenance plan item
     * @param taskId The id of the task within the maintenance plant item
     * @param operationId The id of the operation within the task list
     ...
     * @param planId The id of the maintenance plan
     * @param itemId The id of the maintenance plan item
     * @param taskId The id of the task within the maintenance plan item
     * @param requestBody Operation to add to existing maintenance plan item
     * @returns ProblemDetails Response for other HTTP status codes
     ...
     * @param taskId The id of the task within the maintenance plant item
     * @param operationId The id of the operation within the task list
     * @param materialId The id of the material to modify
     * @param requestBody Operations to add to existing Work order
     * @returns ProblemDetails Response for other HTTP status codes
     * @throws ApiError
     */
