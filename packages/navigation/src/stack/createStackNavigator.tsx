...
function StackNavigator({
  ...
  const mergedScreenOptions = { ...defaultScreenOptions, ...screenOptions };
  ...
  const modifiedDescriptors = createMadDescriptors(descriptors, screenOptions as UnresolvedScreenOptions<MadStackNavigationOptions>, customSubHeader);
