...
type SelectLanguageCellGroupProps = {selectedLanguageCodeDraft: string, setSelectedLanguageCodeDraft: (code: string) => void}

export const SelectLanguageCellGroup = ({selectedLanguageCodeDraft, setSelectedLanguageCodeDraft}: SelectLanguageCellGroupProps) => {
